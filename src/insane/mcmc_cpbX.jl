...
#     ξp, llr = fsbi_pbX(bi, λ, xi(Ξ[bix]), σx, 500)
#     sdXr = 0.0
#     nXr  = 0.0
#   else
#     ξp, llr, sdXr, nXr = 
#       fsbi_pbX(bi, Ξ[d1(bi)], Ξ[d2(bi)], λ, xi(Ξ[bix]), σx, 500)
#   end
...
#     # update llc, ns & L
#     llc += llik_cpb(ξp, λ, σx) - llik_cpb(ξc, λ, σx)
...
#   t0, na, nn, llr =
#     _sim_cpb_t(e(bi), λ, x0, σx, lc, lU, Iρi, 0, 1, 500)
...
#     """
#     here, fix the one with the best trait
#     """
