...
Simulate `iTbdX` for environmental variable z following a Brownian motions 
for birth and death rates, with a limit on the number lineages allowed to reach.
"""
function _sim_gbmbd(t   ::Float64,
  ...
  if nn < nlim
    ...
    zt = linpred(t, tz[ix], tz[ix+1], z[ix], z[ix+1])
    zv = Float64[zt]
    λv = Float64[λt]
    μv = Float64[μt]
    bt = 0.0
    ...
    while true
          ...
          if λorμ(λm, μm)
            ...
            return iTbdX(iTbdX(0.0, δt, 0.0, false, false,
                         ...
                         iTbdX(0.0, δt, 0.0, false, false,
                               Float64[λt1, λt1], Float64[μt1, μt1],
                               Float64[zt, zt]),
                         bt, δt, t, false, false, λv, μv, zv), na, nn
          # if extinction
          else
            return iTbdX(bt, δt, t, true, false, λv, μv, zv), na, nn
          end
        end

        na += 1
        return iTbdX(bt, δt, t, false, false, λv, μv, zv), na, nn
      end
      ...
      ix += Int64(tz[ix+1] >= t)
      zt  = linpred(t, tz[ix], tz[ix+1], z[ix], z[ix+1])
      λt1 = rnorm(λt + (α + βλ*zt)*δt, srδt*σλ)
      μt1 = rnorm(μt, srδt*σμ)
      push!(λv, λt1)
      push!(μv, μt1)
      push!(zv, zt)
      ...
      if divev(λm, μm, δt)
        ...
        if λorμ(λm, μm)
          nn += 1
          td1, na, nn =
            _sim_gbmbd(t, λt1, μt1, α, σλ, σμ, βλ, δt, srδt, ix, z, tz, 
              na, nn, nlim)
          td2, na, nn =
            _sim_gbmbd(t, λt1, μt1, α, σλ, σμ, βλ, δt, srδt, ix, z, tz, 
              na, nn, nlim)

          return iTbdX(td1, td2, bt, δt, δt, false, false, λv, μv, zv), na, nn
        # if eztinction
        else
          return iTbdX(bt, δt, δt, true, false, λv, μv, zv), na, nn
        end
      end
...
#                                 Float64[λt1, λt1], Float64[μt1, μt1],
#                                 Float64[xt1, xt1]),
#                            bt, δt, t, false, false, λv, μv, zv), na, nn, nlr
#             end
#           # if extinction
#           else
#             return iTbdX(bt, δt, t, true, false, λv, μv, zv), na, nn, lr
#           end
#         end
...
#           return iTbdX(bt, δt, t, false, false, λv, μv, zv), na, nn, nlr
#         end
#       end
...
#           return iTbdX(td1, td2, bt, δt, δt, false, false, λv, μv, zv),
#                  na, nn, lr
#         # if extinction
#         else
#           return iTbdX(bt, δt, δt, true, false, λv, μv, zv), na, nn, lr
#         end
#       end
...
#                                Float64[λt1, λt1], Float64[μt1, μt1],
#                                Float64[xt1, xt1]),
#                          bt, δt, t, false, false, λv, μv, zv), nn
#           # if extinction
#           else
#             return iTbdX(bt, δt, t, true, false, λv, μv, zv), nn
#           end
#         end
#         push!(λsp, λt1)
#         push!(μsp, μt1)
...
#         return iTbdX(bt, δt, t, false, false, λv, μv, zv), nn
#       end
...
#           return iTbdX(td1, td2, bt, δt, δt, false, false, λv, μv, zv), nn
#         # if extinction
#         else
#           return iTbdX(bt, δt, δt, true, false, λv, μv, zv), nn
#         end
#       end
...
#                            Float64[λt1, λt1], Float64[μt1, μt1],
#                            Float64[xt1, xt1]),
#                      bt, δt, t, false, false, λv, μv, zv), na, nn, lr
#       # if extinction
#       else
#         return iTbdX(bt, δt, t, true, false, λv, μv, zv), na, nn, lr
#       end
...
#     na += 1
#     lr += log(Iρi)
#     return iTbdX(bt, δt, t, false, false, λv, μv, zv), na, nn, lr
#   end
...
#       return iTbdX(td1, td2, bt, δt, nsδt, false, false, λv, μv, zv), na, nn, lr
#     else
#     # if extinction
#       return iTbdX(bt, δt, nsδt, true, false, λv, μv, zv), na, nn, lr
#     end
#   end
...
#           return iTbdX(td1, td2, bt, δt, δt, false, false, λv, μv, zv), na, nn, lr
#         # if extinction
#         else
#           return iTbdX(bt, δt, δt, true, false, λv, μv, zv), na, nn, lr
#         end
