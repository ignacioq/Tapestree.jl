...
# Simulate `cTct` according to a pure-birth clads.
# """
...
#     _sedges_cladsct(nstar, log(λ0), α, σλ, δt, sqrt(δt), init, maxt)
...
#   # transform to iTree
#   t = cTct(e0, e1, el, λs, ea, e1[1], 1, δt)
...
Simulate `cTct` according to a pure-birth clads for
terminal branches.
"""
