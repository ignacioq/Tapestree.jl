...
function _sim_gbmpbX(t   ::Float64,
  ...
  if nn < nlim
    ...
    while true
      ...
      if divev(λm, δt)
        nn += 1
        td1, nn = _sim_gbmpbX(t, λt1, α, σλ, xt1, βλ, σx, δt, srδt, nn, nlim)
        td2, nn = _sim_gbmpbX(t, λt1, α, σλ, xt1, βλ, σx, δt, srδt, nn, nlim)
...
function _sim_gbmpbX_it(nsδt::Float64,
  ...
  if divev(λm, nsδt)
    nn += 1
    td1, nn, lr =
      _sim_gbmpbX_it(t, λt1, α, σλ, xt1, βλ, σx, δt, srδt, lr, lU, Iρi, nn, nlim)
    td2, nn, lr =
      _sim_gbmpbX_it(t, λt1, α, σλ, xt1, βλ, σx, δt, srδt, lr, lU, Iρi, nn, nlim)
  ...
  if lU < lr && nn < nlim
    ...
    while true
      ...
      if divev(λm, δt)
        nn += 1
        td1, nn, lr =
          _sim_gbmpbX_it(t, λt1, α, σλ, xt1, βλ, σx, δt, srδt, 
            lr, lU, Iρi, nn, nlim)
        td2, nn, lr =
          _sim_gbmpbX_it(t, λt1, α, σλ, xt1, βλ, σx, δt, srδt, 
            lr, lU, Iρi, nn, nlim)
