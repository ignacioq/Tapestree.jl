...
function insane_cbd(tree        ::sT_label, 
  ...
  if occursin(r"^[f|F][A-za-z]*", augmentation)
    R, trees, ps_ml, ss_ml = insane_cbd_fs(tree, out_file, 
      λprior, μprior, niter, nthin, nburn, tune_int, logZ, nitPP, nthPP, K,
      ϵi, λi, μi, λtni, μtni, obj_ar, pupdp, prints, tρ)
