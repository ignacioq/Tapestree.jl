...
function _sim_cfpe_it(t   ::Float64,
  ...
  if lU < lr && nn < nlim
    ...
    if λevent(λ, μ, ψi)
      ...
      d1, na, nn, lr = 
        _sim_cfpe_it(t - tw, λ, μ, ψ, xl, σa, σk, ψts, ix, nep, lr, iρi, 
          na, nn, nlim, xist, xfst, est)
      d2, na, nn, lr = 
        _sim_cfpe_it(t - tw, λ, μ, ψ, xr, σa, σk, ψts, ix, nep, lr, iρi, 
          na, nn, nlim, xist, xfst, est)
