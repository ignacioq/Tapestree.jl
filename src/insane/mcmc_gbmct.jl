  ...
  for i in Base.OneTo(nburn)
    ...
    for pupi in pup
      ...
      if pupi === 1
        ...
        llc, prc, αc, mc, ssλ =
          update_α_ϵ!(αc, lλ(Ξ[1])[1], σλc, ϵc, L, ddλ, llc, prc, mc, th, ssλ,
        ...
        for it in Base.OneTo(niter)
          ...
          for pupi in pup
            ...
            if pupi === 1
              ...
              llc, prc, αc, mc, ssλ =
                update_α_ϵ!(αc, lλ(Ξ[1])[1], σλc, ϵc, L, ddλ, llc, prc, mc, ssλ, 
...
function update_fs!(bix    ::Int64,
  ...
  if isfinite(llr)
    ll1, ddλ1, ssλ1, Σλ1, nλ1 = llik_gbm_ssλ(ξp, α, σλ, ϵ, δt, srδt)
    ll0, ddλ0, ssλ0, Σλ0, nλ0 = llik_gbm_ssλ(ξc, α, σλ, ϵ, δt, srδt)
...
function update_gbm!(bix     ::Int64,
  ...
  @inbounds begin
    ...
    if root && iszero(e(bi))
      ...
      llc, ddλ, ssλ, Σλ =
        _update_gbm!(ξi, α, σλ, ϵ, llc, ddλ, ssλ, Σλ, δt, srδt, false)
      ...
      # if internal branch
        ...
        llc, ddλ, ssλ, Σλ =
          update_triad_ϵ!(lλ(lξi), lλ(ξ1), lλ(ξ2), e(lξi), e(ξ1), e(ξ2),
            fdt(lξi), fdt(ξ1), fdt(ξ2), α, σλ, ϵ, llc, ddλ, ssλ, Σλ, δt, srδt)
    ...
    llc, ddλ, ssλ, Σλ = 
      _update_gbm!(ξ1, α, σλ, ϵ, llc, ddλ, ssλ, Σλ, δt, srδt, 
        iszero(d1(idf[i1])))

    if i2 > 0
      ξ2 = Ξ[i2]
      llc, ddλ, ssλ, Σλ = 
        _update_gbm!(ξ2, α, σλ, ϵ, llc, ddλ, ssλ, Σλ, δt, srδt, 
          iszero(d1(idf[i2])))
    end
  end
